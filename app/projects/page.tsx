...
const PROJECTS: Project[] = [
  ...
  {
    id: "proj-007",
    title: "Decorative Compound Paving",
    category: "cabro",
    location: "Kiambu",
    date: "Dec 2025",
    scope: "Colourful round dumble cabro with decorative flower motifs for a residential compound.",
    highlights: ["Round dumble", "Multi-colour design", "Flower motifs"],
    cover: "/images/WhatsApp Image 2025-12-01 at 8.46.41 AM.jpeg",
    gallery: [
      "/images/WhatsApp Image 2025-12-01 at 8.46.43 AM.jpeg",
      "/images/WhatsApp Image 2025-12-01 at 8.46.45 AM.jpeg",
      "/images/WhatsApp Image 2025-12-01 at 8.46.49 AM.jpeg",
    ],
    tags: ["Residential", "Cabro", "Decorative"],
  },
  {
    id: "proj-008",
    title: "Estate Gate Driveway",
    category: "cabro",
    location: "Nairobi",
    date: "Jan 2026",
    scope: "Grey zigzag heavy-duty cabro installed at estate entrance driveway with gate access.",
    highlights: ["Zigzag pattern", "Gate-to-gate coverage", "Heavy duty"],
    cover: "/images/zizag2.jpg",
    gallery: [
      "/images/zigzag.jpeg",
      "/images/industrial yard.png",
    ],
  ...
  {
    id: "proj-009",
    title: "Cobblestone Curved Driveway",
    category: "cabro",
    location: "Runda",
    date: "Mar 2026",
    scope: "Charcoal cobblestone pavers laid in flowing fan curves for a premium curved driveway.",
    highlights: ["Cobblestone finish", "Curved pattern", "Premium look"],
    cover: "/images/Perfect Work of Paver Block.jpeg",
    gallery: [
      "/images/cobblestone.png",
      "/images/Driveways.png",
    ],
    tags: ["Residential", "Cabro", "Premium"],
  },
  {
    id: "proj-010",
    ...
    location: "Karen",
    date: "Feb 2026",
    scope: "Multi-tier retaining wall with integrated steps and landscaped planting beds.",
    highlights: ["Retaining blocks", "Integrated steps", "Erosion control"],
    cover: "/images/kerbs erosion control.png",
    gallery: [
      "/images/Retaining Walls.png",
      "/images/kerbs-drainage.jpg",
    ],
    tags: ["Retaining Walls", "Landscaping", "Erosion Control"],
  },
  {
    id: "proj-011",
    title: "Luxury Hex Patio Installation",
    category: "cabro",
    location: "Kitisuru",
    date: "Mar 2026",
    scope: "Premium hexagonal paving with charcoal and beige tones for outdoor lounge area.",
    highlights: ["Hexagonal pattern", "Night lighting ready", "Outdoor lounge"],
    cover: "/images/Masterpieces.jpeg",
    gallery: [
      "/images/hexa deco.jpg",
      "/images/square pave.jpg",
    ],
    tags: ["Residential", "Cabro", "Premium"],
  },
  {
    id: "proj-012",
    title: "Park Walkway Paving",
    category: "cabro",
    location: "Ruaka",
    date: "Jan 2026",
    scope: "Round dumble pavers in pink and beige tones for a landscaped park walkway.",
    highlights: ["Round dumble", "Park pathway", "Landscaped edges"],
    cover: "/images/round trihex 1.jpeg",
    gallery: [
      "/images/Garden cabros.png",
      "/images/luxury pathway.png",
    ],
    tags: ["Landscape", "Cabro", "Walkway"],
  },
  {
    id: "proj-013",
    title: "Concrete Fence Boundary",
    category: "fencing",
    location: "Limuru",
    date: "Dec 2025",
    scope: "Concrete fence posts with chain-link and barbed wire for a farm perimeter.",
    highlights: ["Concrete posts", "Chain-link mesh", "Barbed wire top"],
    cover: "/images/concrete fence.png",
    gallery: [
      "/images/fence.png",
      "/images/products/fencing-posts/fence.png",
    ],
    tags: ["Fencing", "Farm", "Perimeter"],
  },
];
