...
export default function ServicesPage() {
  return (
    <main className="bg-white dark:bg-[#0A0C10] text-slate-900 dark:text-slate-200">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-3">
            {services.map((card) => (
              <div
                key={card.title}
                className="rounded-3xl border border-black/10 dark:border-slate-700 bg-white dark:bg-slate-900 p-6 shadow-sm hover:shadow-md transition"
              >
      ...
      {/* SUPPLY CATALOG */}
      <section className="py-14 sm:py-16 bg-slate-50 dark:bg-[#0F1219]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <p className="text-sm font-semibold tracking-wider" style={{ color: BRAND }}>
              SUPPLY CATALOG
          ...
          <div className="mt-10 grid gap-5 lg:grid-cols-2">
            {productGroups.map((g) => (
              <div
                key={g.title}
                className="rounded-3xl border border-black/10 dark:border-slate-700 bg-white dark:bg-slate-900 p-6 shadow-sm"
              >
          ...
          <div className="mt-10 grid gap-4 md:grid-cols-3">
            {[
              ...
              <div key={x.title} className="rounded-3xl border border-black/10 dark:border-slate-700 bg-white dark:bg-slate-900 p-6 shadow-sm">
                <div className="flex items-center gap-3">
      ...
      <section className="py-14 sm:py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid gap-8 lg:grid-cols-2 items-start">
            <div>
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                {serviceAreas.primary.map((a) => (
                  <span
                    key={a}
                    className="rounded-full border border-black/10 dark:border-slate-700 bg-white dark:bg-slate-900 px-4 py-2 text-sm text-slate-700 shadow-sm"
                  >
                    {a}
                  </span>
                ))}
              ...
              <div className="mt-6 rounded-3xl border border-black/10 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 p-6">
            ...
            <div className="rounded-3xl border border-black/10 dark:border-slate-700 bg-white dark:bg-slate-900 overflow-hidden shadow-sm">
              <div className="relative h-[340px] w-full bg-slate-100">
                ...
                <div className="absolute bottom-5 left-5 right-5">
                  <div className="rounded-2xl border border-black/10 dark:border-slate-700 bg-white dark:bg-slate-900/90 backdrop-blur px-4 py-3">
      ...
      <section className="py-14 sm:py-16 bg-slate-50 dark:bg-[#0F1219]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {projects.map((p) => (
              <div key={p.title} className="rounded-3xl overflow-hidden border border-black/10 dark:border-slate-700 bg-white dark:bg-slate-900 shadow-sm">
          ...
          <div className="mt-8">
            <Link
              href="/products"
              className="inline-flex items-center gap-2 rounded-full px-5 py-3 text-sm font-semibold border border-black/10 dark:border-slate-700 bg-white dark:bg-slate-900 hover:bg-white/80 transition"
              style={{ color: BRAND }}
            >
      ...
      <section className="py-14 sm:py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid gap-5 lg:grid-cols-2">
            {faqs.map((f) => (
              <div key={f.q} className="rounded-3xl border border-black/10 dark:border-slate-700 bg-white dark:bg-slate-900 p-6 shadow-sm">
                <div className="flex items-start gap-3">
                  <div className="h-10 w-10 rounded-2xl grid place-items-center" style={{ backgroundColor: `${BRAND}1A` }}>
