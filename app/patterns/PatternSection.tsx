...
const patternsData: Pattern[] = [
  ...
  {
    id: 7,
    name: "3D Zigzag Coloured",
    type: "zigzag",
    use: "residential",
    thickness: "60mm",
    load: "Medium",
    features: ["3D effect", "Multi-colour", "Decorative"],
    image: "/images/3D-zigzag-Coloured-Paving-Blocks.jpg",
  },
  {
    id: 8,
    name: "Colorado Shape",
    ...
    thickness: "60mm",
    load: "Medium",
    features: ["Unique profile", "Tight interlock", "Driveways"],
  ...
  },
  {
    ...
    thickness: "60mm",
    load: "Medium",
    features: ["Premium look", "Entrances", "Feature areas"],
    image: "/images/crown shape.jpeg",
  },
  {
    id: 10,
    name: "I-Shape Heavy Duty",
    type: "interlocking",
    use: "industrial",
    thickness: "80mm",
    load: "Extra Heavy",
    features: ["Max interlock", "Container yards", "Truck bays"],
  ...
  },
  {
    ...
    thickness: "80mm",
    load: "Heavy",
    features: ["Directional grip", "Parking lots", "Access roads"],
  ...
  },
  {
    ...
    thickness: "60mm",
    load: "Light",
    features: ["Rustic charm", "Garden paths", "Heritage look"],
  ...
  },
  {
    ...
    thickness: "60mm",
    load: "Medium",
    features: ["Curved edges", "Flowing designs", "Compounds"],
  ...
  },
  {
    ...
    thickness: "60mm",
    load: "Light",
    features: ["Playgrounds", "Decorative zones", "Gardens"],
  ...
  },
  {
    ...
    thickness: "60mm",
    load: "Medium",
    features: ["Flowing pattern", "Pool surrounds", "Resorts"],
  ...
  },
  {
    ...
    thickness: "60mm",
    load: "Light",
    features: ["Curved layouts", "Circles", "Entrance features"],
  ...
  },
  {
    ...
    thickness: "60mm",
    load: "Medium",
    features: ["Rotational pattern", "Decorative compounds", "Show homes"],
  ...
  },
  {
    ...
    thickness: "60mm",
    load: "Medium",
    features: ["3D optical illusion", "Modern look", "Showrooms"],
  ...
  },
  {
    ...
    thickness: "60mm",
    load: "Medium",
    features: ["Classic look", "Heritage style", "Verandas"],
  ...
  },
  {
    ...
    thickness: "60mm",
    load: "Light",
    features: ["Outdoor patios", "Fire pit areas", "Garden lounges"],
  ...
  },
  {
    ...
    thickness: "60mm",
    load: "Light",
    features: ["Pool surrounds", "Resort decks", "Luxury gardens"],
  ...
  },
  {
    ...
    thickness: "80mm",
    load: "Heavy",
    features: ["Walkways", "Ramps", "Public access areas"],
    image: "/images/Australian.jpeg",
  },
  {
    id: 23,
    name: "3D Zigzag Installed",
    type: "zigzag",
    use: "residential",
    thickness: "60mm",
    load: "Medium",
    features: ["Installed finish", "Flower motifs", "Decorative"],
    image: "/images/3D zig-zag installed.jpeg",
  },
  {
    id: 24,
    name: "Chinaman Paver",
    ...
    thickness: "60mm",
    load: "Medium",
    features: ["Bold stripes", "Large compounds", "Institutions"],
