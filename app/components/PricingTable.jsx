...
export default function PricingTable() {
  ...
  return (
    <section id="pricing" className="py-20 md:py-28 bg-gradient-to-b from-[#0D1B30] to-gray-900">
      <div className="container mx-auto px-4 md:px-8">
        {/* Header */}
        <div className="text-center max-w-3xl mx-auto mb-12">
          <span className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-[#FFC20E]/20 to-transparent border border-[#FFC20E]/30 px-4 py-2 mb-6">
            <div className="w-2 h-2 rounded-full bg-[#FFC20E] animate-pulse" />
            <span className="text-sm font-medium tracking-widest text-[#FFC20E] uppercase">
              Transparent Pricing
            </span>
          </span>
          
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Competitive <span className="text-[#FFC20E]">Pricing</span>
          </h2>
          ...
          <div className="inline-flex rounded-lg bg-gray-800/50 p-1 border border-gray-700 mb-8">
            <button
              ...
              className={`px-6 py-3 rounded-md font-medium transition-all ${
                view === "retail"
                  ? "bg-gradient-to-r from-[#FFC20E] to-[#F0B429] text-[#0D1B30]"
              ...
              {tabs.map((tab) => (
                <button
                  ...
                  className={`px-6 py-3 rounded-full font-medium transition-all duration-300 ${
                    activeTab === tab.id
                      ? "bg-gradient-to-r from-[#FFC20E] to-[#F0B429] text-[#0D1B30] shadow-lg shadow-[#FFC20E]/20"
                        ...
                        >
                          <td className="py-4 px-6">
                            <div className="flex items-center gap-3">
                              ...
                              {row.popular && (
                                <span className="px-2 py-1 rounded-full bg-gradient-to-r from-[#FFC20E] to-[#F0B429] text-[#0D1B30] text-xs font-bold">
                                  Popular
                                </span>
                              )}
                              {row.heavy && (
                  ...
                  <ul className="grid md:grid-cols-2 lg:grid-cols-3 gap-3">
                    {productData[activeTab].notes.map((note, index) => (
                      <li key={index} className="flex items-start gap-3">
                        <div className="w-6 h-6 rounded-full bg-gradient-to-r from-[#FFC20E]/20 to-transparent flex items-center justify-center mt-0.5">
                          <svg className="w-3 h-3 text-[#FFC20E]" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="bg-gradient-to-b from-gray-900/80 to-gray-800/50 rounded-2xl border border-gray-800 p-8 mb-12">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                  {wholesaleData.brackets.map((bracket, index) => (
                    <div
                      key={index}
                      className="group relative bg-gradient-to-b from-gray-900 to-gray-800 rounded-xl border border-gray-800 p-6 hover:border-[#FFC20E]/50 transition-all"
                    >
                      ...
                      <div className="mb-4">
                        ...
                        <div className="text-3xl font-bold text-[#FFC20E]">{bracket.discount}</div>
                      </div>
                  ...
                  {wholesaleData.packages.map((pkg, index) => (
                    <div
                      ...
                      className={`group relative bg-gradient-to-b from-gray-900 to-gray-800 rounded-2xl border ${
                        pkg.popular
                          ? "border-[#FFC20E] shadow-2xl shadow-[#FFC20E]/10"
                          : "border-gray-800"
                      } p-8 hover:border-[#FFC20E]/50 transition-all`}
                    >
                      {pkg.popular && (
                        <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                          <span className="px-4 py-1 rounded-full bg-gradient-to-r from-[#FFC20E] to-[#F0B429] text-[#0D1B30] text-sm font-bold">
                            Most Popular
                          </span>
                        </div>
                      )}
                      ...
                      <ul className="space-y-3 mb-8">
                        {pkg.features.map((feature, fIndex) => (
                          <li key={fIndex} className="flex items-center gap-3">
                            <div className="w-5 h-5 rounded-full bg-gradient-to-r from-[#FFC20E]/20 to-transparent flex items-center justify-center">
                              <svg className="w-3 h-3 text-[#FFC20E]" fill="currentColor" viewBox="0 0 20 20">
                                <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                              </svg>
                            </div>
                      ...
                      <Link
                        ...
                        className={`block text-center py-3 rounded-lg font-semibold transition-all ${
                          pkg.popular
                            ? "bg-gradient-to-r from-[#FFC20E] to-[#F0B429] text-[#0D1B30] hover:shadow-lg hover:shadow-[#FFC20E]/30"
                            : "border border-gray-700 text-white hover:border-[#FFC20E]/50 hover:bg-[#FFC20E]/5"
                        }`}
                      >
        ...
        {/* CTA Section */}
        <div className="max-w-4xl mx-auto p-8 rounded-2xl bg-gradient-to-r from-gray-900/50 to-[#0D1B30]/50 border border-gray-800 relative overflow-hidden">
          <div className="absolute inset-0 opacity-10">
            <div className="absolute inset-0" style={{
              backgroundImage: `url("data:image/svg+xml,%3Csvg width='100' height=' 0' viewBox='0 0 100 100' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M11 18c3.866 0 7-3.134 7-7s-3.134-7-7-7-7 3.134-7 7 3.134 7 7 7zm48 25c3.866 0 7-3.134 7-7s-3.134-7-7-7-7 3.134-7 7 3.134 7 7 7zm-43-7c1.657 0 3-1.343 3-3s-1.343-3-3-3-3 1.343-3 3 1.343 3 3 3zm63 31c1.657 0 3-1.343 3-3s-1.343-3-3-3-3 1.343-3 3 1.343 3 3 3zM34 90c1.657 0 3-1.343 3-3s-1.343-3-3-3-3 1.343-3 3 1.343 3 3 3zm56-76c1.657 0 3-1.343 3-3s-1.343-3-3-3-3 1.343-3 3 1.343 3 3 3zM12 86c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm28-65c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm23-11c2.76 0 5-2.24 5-5s-2.24-5-5-5-5 2.24-5 5 2.24 5 5 5zm-6 60c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm29 22c2.76 0 5-2.24 5-5s-2.24-5-5-5-5 2.24-5 5 2.24 5 5 5zM32 63c2.76 0 5-2.24 5-5s-2.24-5-5-5-5 2.24-5 5 2.24 5 5 5zm57-13c2.76 0 5-2.24 5-5s-2.24-5-5-5-5 2.24-5 5 2.24 5 5 5zm-9-21c1.105 0 2-.895 2-2s-.895-2-2-2-2 .895-2 2 .895 2 2 2zM60 91c1.105 0 2-.895 2-2s-.895-2-2-2-2 .895-2 2 .895 2 2 2zM35 41c1.105 0 2-.895 2-2s-.895-2-2-2-2 .895-2 2 .895 2 2 2zM12 60c1.105 0 2-.895 2-2s-.895-2-2-2-2 .895-2 2 .895 2 2 2z' fill='%23D4A017' fill-opacity='0.4' fill-rule='evenodd'/%3E%3C/svg%3E")`,
          ...
          <div className="relative z-10 text-center">
            <div className="inline-flex items-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-full bg-gradient-to-r from-[#FFC20E] to-[#F0B429] flex items-center justify-center">
                <svg className="w-6 h-6 text-[#0D1B30]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link
                href="#quote"
                className="px-8 py-4 bg-gradient-to-r from-[#FFC20E] to-[#F0B429] text-[#0D1B30] font-semibold rounded-lg hover:shadow-2xl hover:shadow-[#FFC20E]/30 transition-all flex items-center gap-3"
              >
