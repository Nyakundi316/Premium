...
export default function PatternsGallery() {
  ...
  const patterns = [
    ...
    },
    {
      ...
      name: "Gear Swirl",
      category: "interlocking",
      description: "Rotational gear-shaped pavers for decorative compounds.",
      thickness: "60mm",
      load: "Medium",
      colors: ["Red", "Charcoal"],
      application: "Courtyards",
    ...
    },
    {
      ...
      name: "3D Y-Block",
      category: "custom",
      description: "Geometric Y-shaped blocks creating 3D optical illusion.",
      thickness: "60mm",
      load: "Medium",
      colors: ["Grey", "Charcoal"],
      application: "Driveways",
    ...
    },
    {
      ...
      name: "Hexagon Deco",
      category: "hexagonal",
      description: "Mixed-tone hexagons for upscale outdoor patios.",
      thickness: "60mm",
      load: "Medium",
      colors: ["Grey", "Charcoal"],
      application: "Commercial",
    ...
    },
    {
      ...
      category: "custom",
      description: "Large diamond grid pattern for pool surrounds and resorts.",
      thickness: "60mm",
      load: "Medium",
      colors: ["Beige", "Grey"],
      application: "Courtyards",
